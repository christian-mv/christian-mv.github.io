var size = 0;
function categories_Ln0(feature, value, size) {
                switch(value) {case '0':
...
case '7':
        ...
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,0.55)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(0,0,255,0.55)'})
                    ...
                    break;}};
var styleCache_Ln0={}
var style_Ln0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_Ln0(feature, value, size);
    key = value + "_" + labelText
    if (!styleCache_Ln0[key]){
        ...
        styleCache_Ln0[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_Ln0[key]];
